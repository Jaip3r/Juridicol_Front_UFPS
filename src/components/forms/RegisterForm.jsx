import { Button, Flex, FormControl, FormErrorMessage, FormLabel, Input, Select, Stack } from "@chakra-ui/react";
...
export const RegisterForm = () => {
    ...
    const registerUserSchema = yup.object().shape({
        ...
        password: yup.string()
            ...
            .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/, "La contraseña debe tener al menos 8 caracteres, incluyendo una mayúscula, una minúscula, un número y un carácter especial"),
        codigo: yup.string()
